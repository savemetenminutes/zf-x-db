...
class AlterTableDecorator extends Zfx_AlterTable implements PlatformDecoratorInterface
{
    /**
     * @var Zfx_AlterTable
     */
    ...
    protected function processAutoIncrement() {
